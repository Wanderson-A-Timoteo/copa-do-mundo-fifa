...
const imagens: Imagem[] = [
  {
    slug: "metlife",
    ext: "jpg",
    url: "https://upload.wikimedia.org/wikipedia/commons/0/04/Metlife_stadium_(Aerial_view).jpg",
  },
  {
    slug: "sofi",
    ext: "jpg",
    url: "https://upload.wikimedia.org/wikipedia/commons/5/5a/SoFi_Stadium.jpg",
  },
  {
    slug: "att-stadium",
    ext: "jpeg",
  ...
  },
  {
    slug: "nrg-stadium",
    ext: "jpg",
    url: "https://upload.wikimedia.org/wikipedia/commons/3/36/Reliant_Stadium_Aerial.JPG",
  },
  {
    slug: "mercedes-benz",
    ext: "jpg",
    url: "https://images.unsplash.com/photo-1526490025555-53f98769ce26?fm=jpg&q=80&w=1920",
  },
  {
    slug: "levis-stadium",
    ext: "jpg",
  ...
  },
  {
    ...
    ext: "jpg",
    url: "https://upload.wikimedia.org/wikipedia/commons/a/a1/Lincoln_Financial_Field_(Aerial_view).jpg",
  },
  {
    slug: "lumen-field",
    ext: "jpg",
  ...
  },
  {
    ...
    ext: "jpg",
    url: "https://images.unsplash.com/photo-1767584413129-2ad2941b7e46?fm=jpg&q=80&w=1920",
  },
  {
    slug: "arrowhead",
    ext: "jpg",
  ...
  },
  {
    slug: "hard-rock",
    ext: "jpg",
    url: "https://images.unsplash.com/photo-1751232576230-e065bfa42aaf?fm=jpg&q=80&w=1920",
  },
  {
    slug: "estadio-bbva",
    ext: "jpg",
...
async function baixar(img: Imagem, tentativa = 1): Promise<boolean> {
  ...
  try {
    const resp = await fetch(img.url, {
      headers: {
        "User-Agent":
          "Mozilla/5.0 (compatible; Copa2026Download/2.0; +https://copa-do-mundo-fifa.vercel.app)",
