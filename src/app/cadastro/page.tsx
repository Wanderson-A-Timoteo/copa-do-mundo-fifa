      ...
      <div className="flex min-h-screen flex-col md:flex-row">
        <div className="flex w-full items-center justify-center p-8 md:w-2/5">
          <div className="w-full max-w-sm">
            ...
            <p className="mb-8 text-zinc-500">Preencha os dados para se cadastrar</p>
        ...
        <div className="relative flex h-48 w-full md:h-auto md:w-3/5">
          ...
          <div className="absolute bottom-6 left-6 text-zinc-50">
            <h1 className="text-3xl font-bold">Faça parte</h1>
            <p className="text-lg text-zinc-50/80">Monte seu álbum e acompanhe os jogos</p>
          </div>
        </div>
      </div>
    </PaginaAnimada>
