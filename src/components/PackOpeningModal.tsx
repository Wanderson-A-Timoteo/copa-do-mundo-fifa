...
export default function PackOpeningModal({ figurinhas, onClose }: PackOpeningModalProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-zinc-900/90 backdrop-blur-md p-4 sm:p-8"
      onClick={flippedIndex.length === figurinhas.length ? onClose : undefined}
    >
      <div className="w-full max-w-5xl text-center" onClick={(e) => e.stopPropagation()}>
